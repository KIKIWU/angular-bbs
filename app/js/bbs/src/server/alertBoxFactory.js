angular.module('bbsServer').factory('alertBoxFactory',[function(){
    var width = 600,top = 50,waitTime = 4,type = 'warn';
    var typeColor = {success : {bgColor : '#dff0d8',fontColor : '#3c763d'},info : {bgColor : '#d9edf7',fontColor : '#31708f'},warn : {bgColor : '#fcf8e3',fontColor : '#8a6d3b'},error : {bgColor : '#f2dede',fontColor : '#a94442'}}
    ...
    return function(content,config){
        ...
        if(angular.isFunction(config.close)){
            ...
            var closeBtn = angular.element(closeBtnHtml);

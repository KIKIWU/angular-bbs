angular.module('bbsServer').service('domService',['$window',function(window){
    this.position = function(element){
        ...
        if(element.getBoundingClientRect){
            var position, scrollPos, e, f, g, h;
            ...
            return {left: parseInt(position.left + scrollPos.left - h, 10) || 0,top: parseInt(position.top + scrollPos.top - g, 10) || 0}
        }else{
            var d = [element.offsetLeft, element.offsetTop];
            ...
            return {left: parseInt(d[0], 10),top: parseInt(d[1], 10)}
    }
